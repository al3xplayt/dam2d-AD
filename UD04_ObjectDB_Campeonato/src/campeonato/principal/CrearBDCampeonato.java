...
public class CrearBDCampeonato {
	...
	public static void main(String[] args) {
		...
		Partido partido01 = new Partido(equipo1, equipo2, "2022-04-06", "3-0");
		Partido partido02 = new Partido(equipo3, equipo4, "2022-06-04", "2-2");
		Partido partido03 = new Partido(equipo1, equipo3, "2022-06-18", "1-2");
		Partido partido04 = new Partido(equipo2, equipo4, "2022-06-18", "2-0");
		Partido partido05 = new Partido(equipo1, equipo4, "2022-07-02", "0-0");
		Partido partido06 = new Partido(equipo2, equipo3, "2022-07-02", "1-1");
		Partido partido07 = new Partido(equipo2, equipo1, "2022-07-16", "1-0");
		Partido partido08 = new Partido(equipo4, equipo3, "2022-07-16", "2-3");
		Partido partido09 = new Partido(equipo3, equipo1, "2022-07-30", "0-1");
		Partido partido10 = new Partido(equipo4, equipo2, "2022-07-30", "3-3");
		Partido partido11 = new Partido(equipo4, equipo1, "2022-08-13", "0-2");
		Partido partido12 = new Partido(equipo3, equipo2, "2022-08-13", "2-1");
		
		//Creo Factoría de EntityManager (gestor de base de datos)
		...
		try {
			...
			//Rollback automático al intentar insertar objetos con un id ya existente.
			System.err.println("Se ha producido un error en la inserción de los datos. "
